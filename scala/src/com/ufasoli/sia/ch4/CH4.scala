import com.ufasoli.sia.ch4._
import com.ufasoli.sia.ch4.Just
...
object CH4 {
  def main(args: Array[String]) {
    ...
    artistsForComprehension()
    artistsWithAlbumsForComprehension()
  ...
  def artistsForComprehension() {

    println("********************************")
    println("artistsForComprehension")
    println("********************************")
    val artists = List(Artist("Pink Floyd", "Rock"), Artist("Led Zeppelin", "Rock"),
      Artist("Michael Jackson", "Pop"),
      Artist("Above & Beyond", "trance")
    )

    val rockArtists = for (Artist(name, genre) <- artists; if genre == "Rock") yield name

    println(s"Filtering rock artists in $artists")
    println(rockArtists)


    println("********************************")
    println("END artistsForComprehension")
    println("********************************")
  }

  def artistsWithAlbumsForComprehension() {

    println("********************************")
    println("artistsWithAlbumsForComprehension")
    println("********************************")
    ...
    val rockArtistsWithAlbums = for { ArtistWithAlbums(artist, albums) <- artistsWithAlbums
          album <- albums
          if (artist.genre == "Rock")
    } yield album

    println(s"Filtering rock artists in $artistsWithAlbums")
    println(rockArtistsWithAlbums)


    println("********************************")
    println("END artistsWithAlbumsForComprehension")
    println("********************************")
...
def folds() {
  ...
  println("Calculating sum of list List(1,2,3,4) : " + List(1, 2, 3, 4).foldLeft(0) {
    _ + _
  })
  ...
  println("Calculating length of list List(1,2,3,4) : " + List(1, 2, 3, 4).foldLeft(0) {
    (a, b) => println("a:" + a + "b :" + b); a + 1
  })
...
def customFunctionObjects() {
  ...
  println(folddl(List("1", "2", "3"), "0") {
    _ + _
  })
  println(folddl(IndexedSeq("1", "2", "3"), "0") {
    _ + _
  })
  println(folddl(Set("1", "2", "3"), "0") {
    _ + _
  })
  ...
  println(mapForComprehension(new Function1[Int, Int] {
    def apply(p: Int) = {
      p + 1
    }
  }, List(10, 20, 30)))
